...
METRIC_KEYS = (
    ...
    "RootDriftMean",
    "RootFlatRangeMean",
    "RootHeightViolationRate",
    "ReferenceRangeViolationRate",
    "JointPositionStdMean",
    "JointPositionRangeMean",
    "JointSmoothnessJerkMean",
    "RootSmoothnessJerkMean",
)
COUNT_KEYS = ("num_motion_files", "num_scored_files", "num_valid_motion_files")
...
def render_markdown(rows):
    headers = ["Model", "Files", "Scored", "Valid", *METRIC_KEYS]
    lines = [
        "| " + " | ".join(headers) + " |",
        "|---|---:|---:|---:|"
        + "---:|" * len(METRIC_KEYS),
    ...
    for row in rows:
        values = [
            ...
            row.get("num_valid_motion_files"),
